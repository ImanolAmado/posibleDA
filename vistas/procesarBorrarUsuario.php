...
<div class="container-fluid">
    <form method="post">
        ...
        <button class="btn btn-primary"><a href="todosLosUsuarios.php" style="text-decoration: none; color:white">Cancelar</a></button>
        <button id="eliminarUsuario" class="btn btn-danger">Eliminar</button><br><br>
    </form>
